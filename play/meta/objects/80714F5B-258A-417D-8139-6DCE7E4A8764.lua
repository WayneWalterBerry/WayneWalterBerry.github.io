return {
    ...
    description = "A round hole in the wooden stage floor. You can see darkness below it. The more you dig, the bigger a hole gets! The more you take from it... the bigger it gets!",
    ...
    on_smell = "Cool, musty air rises from below. Smells like under a stage.",
