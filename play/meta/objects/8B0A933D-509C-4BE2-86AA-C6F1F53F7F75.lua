return {
    guid = "{8B0A933D-509C-4BE2-86AA-C6F1F53F7F75}",
    template = "furniture",

    id = "welcome-sign",
    material = "plastic",
    keywords = {"sign", "welcome sign", "welcome", "big sign"},
    size = 5,
    weight = 10,
    categories = {"readable", "furniture"},
    portable = false,
    ...
    on_listen = "The sign is quiet. But the speakers nearby are buzzing!",
    on_taste = "You lick the sign. Tastes like plastic. Silly!",
