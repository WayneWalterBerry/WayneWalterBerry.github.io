...
return {
    ...
    states = {
        locked = {
            ...
            on_examine = "Latched from the inside. The iron bar is simple but effective. No keyhole — just a bar on the other side.",
            on_feel = "Thin oak, warm and greasy. The latch holds from within.",
            ...
            blocked_message = "This door is firmly locked. The latch is on the inside — simple iron, but effective. There's no keyhole to pick.",
        },
    },
